...
public class FabHideDownOnScroll extends FloatingActionButton.Behavior {

    public FabHideDownOnScroll() {
    }

    public FabHideDownOnScroll(Context context, AttributeSet attrs) {
        super();
    }
    ...
    public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull FloatingActionButton child,
        ...
        System.out.println("dxUnconsumed: " + dxUnconsumed);
    }
