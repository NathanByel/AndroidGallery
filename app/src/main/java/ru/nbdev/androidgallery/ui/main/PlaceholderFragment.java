...
public class PlaceholderFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        final TextView textView = root.findViewById(R.id.nature_item);
        pageViewModel.getImageItem().observe(this, new Observer<ImageItem>() {
            @Override
            public void onChanged(ImageItem imageItem) {
                textView.setCompoundDrawables(null, imageItem.getPreviewThumb(getResources(), 200, 200), null, null);
